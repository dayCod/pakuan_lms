...
/* measurement in cm */
    $freeloancard_page_margin = 0.2;
    $freeloancard_items_margin = 0.1;
    $freeloancard_items_per_row = 1; //

  /* measurement in cm*/
    $freeloancard_factor = "37.795275591"; //cm to px

    // Items Settings
    // Ubah 1 jika ditampilkan , 0 jika tidak tampil
    $freeloancard_include_id_label = 1; // no anggota
    $freeloancard_include_name_label = 1; // nama anggota
    $freeloancard_include_pin_label = 0; // nim
    $freeloancard_include_inst_label = 1; // prodi 
    $freeloancard_include_email_label = 0; // email
    $freeloancard_include_address_label = 1; // alamat

    // Freeloancard Settings , Ubah variabel berikut ,
    $freeloancard_box_width = 29;
    $freeloancard_box_height = 19;
    $freeloancard_logo = "logo1.png";
    $freeloancard_front_header1_text = "</br>Perpustakaan Fakultas Ekonomi</br>Universitas Pakuan "; // gunakan tag <br /> untuk pindah baris baru
    $freeloancard_front_header1_font_size = "22";
    $freeloancard_front_header2_text = "Jl. Pakuan PO Box 452 Bogor 16143 Telp. (0251) 8314918";
    $freeloancard_front_header2_font_size = "18";
    $freeloancard_front_header3_text = "</br>SURAT KETERANGAN BEBAS PUSTAKA<br /> <b>Nomor:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/Perps/FEUP/&nbsp;&nbsp;&nbsp;&nbsp;/20    </b>"; // gunakan tag <br /> untuk pindah baris baru
    $freeloancard_front_header3_font_size = "20";
    $freeloancard_header_color = "#01005F"; //e.g. :#0066FF, green, etc.
    $freeloancard_front_body1_text = "Kepala Perpustakaan Fakultas Ekonomi Universitas Pakuan dengan ini menyatakan:"; // gunakan tag <br /> untuk pindah baris baru
    $freeloancard_front_body1_font_size = "18";
    $freeloancard_front_body2_text = "<br><br><br>(Bebas Mempunyai) Tunggakan Buku Yang masih dipertanggungjawabkan berupa pinjaman Buku maupun yang bersangkutan dengan perpustakaan.<br /><br />Demikian Surat Keterangan ini dibuat untuk dapat dipergunakan sebagaimana mestinya."; // gunakan tag <br /> untuk pindah baris baru
    $freeloancard_front_body2_font_size = "18";
    $freeloancard_bio_font_size = "18";
    $freeloancard_bio_font_weight = "bold";
    $freeloancard_bio_label_width = "800";
    $freeloancard_lokasi_stempel = "</br><br><br><br>Bogor,__________________";
    $freeloancard_pejabat_stempel = "</br>Ramlan,SE.,MM </br> Kepala Perpustakaan";
    $freeloancard_nip_pejabat_stempel = "08091988" ; 
    $freeloancard_gambar_ttd_stempel = "ttd.png"; // gambar tanda tangan Kep.Sek atau Kep.Perpus , gunakan gambar transparent
