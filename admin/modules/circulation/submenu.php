...
$menu[] = array(__('Reference Service'), MWB.'circulation/reference_service.php', __('Reference Service'));
$menu[] = array(__('Suggestion List'), MWB.'circulation/suggestion.php', __('Suggestion List'));