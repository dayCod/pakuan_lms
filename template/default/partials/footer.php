<footer class="s-footer">
  ...
  if(  !( isset($_GET['search']) || isset($_GET['title']) || isset($_GET['keywords']) || isset($_GET['p']) ) ) :
    ...
    if ($num_rows = $topbook->num_rows && $sysconf['enable_promote_titles']) :
    ?>
    <!-- Featured
    ============================================= -->
    ...
    <div class="row">
      <div class="col-lg-6 col-sm-3 col-xs-12">
        <div class="s-footer-tagline">
          <a href="//slims.web.id" target="_blank"><?php echo SENAYAN_VERSION; ?></a><p>PUSAT TEKNOLOGI DAN KOMUNIKASI UNIVERSITAS PAKUAN</p>
        </div>
      </div>
