    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-sm-9 col-xs-12 animated fadeInUp delay2">
        ...
        <?php
         ...
         if (isset($_GET['search'])) {
           include 'partials/gmd_button_result.php';
         }
          // Generate Output
          // catch empty list
      ...
      <div class="col-lg-4 col-sm-3 col-xs-12 animated fadeInUp delay4">
        ...
        <?php
          ...
          <?php include 'partials/latest_collection.php'; ?>
      </div>
    </div>
  </div>
...
<!-- Homepage
============================================= -->
<main id="content" class="s-main" role="main"><br><br><br><br><br><br>
    ...
    <div class="s-gmd animated fadeInUp delay4">
      <?php include 'partials/gmd_button.php'; ?>
    </div>
