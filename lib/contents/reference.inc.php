...
/**
 * @Author: ido
 * @Date:   2016-10-09 17:41:23
 * @Last Modified by:   ido
 * @Last Modified time: 2016-10-09 21:24:00
 */
...
if (isset($_POST['saveData'])) {
  ...
  $data['ref_desc'] = trim($dbs->escape_string(strip_tags($_POST['description'])));
  $data['status'] = 0;
  ...
  $insert = $sql_op->insert('reference', $data);
  // var_dump($insert);
  if ($insert) {
    utility::jsAlert('Permintaan berhasil dikirim.');
    echo '<script>window.location.href="index.php";</script>';
  } else {
    utility::jsAlert('Permintaan gagal dikirim.');
  }
  exit();
}
?>
<div class="row">
  <div class="col-md-12">
    <div class="row">
      <div class="col-xs-9">
        <h3>FORMULIR PERMINTAAN<br>PENELUSURAN INFORMASI<br>FAKULTAS EKONOMI<br>UNIVERSITAS PAKUAN</h3>
      </div>
      <div class="col-xs-3">
        <h3>
          <img class="s-logo" src="./template/default/img/logo.png" autofocus>
        </h3> 
      </div>
    </div>
    <hr>
    ...
    <?php if ($sysconf['captcha']['smc']['enable']) { ?>
      ...
      <?php } ?>
    <?php } ?>
    <form class="form" action="index.php?p=reference" method="post">
      <div class="row">
          <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <label for="description">Deskripsi Permintaan Penelusuran Informasi</label>
      ...
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
          <br>
          <button type="submit" name="saveData" class="btn btn-lg btn-block btn-primary">Kirim Permintaan</button>
        </div>
      </div>
      <hr>
    </form>
